...
const Banner = () => {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-gradient-to-br from-white via-[#FDFFE9] to-white pt-16">
      <section className="flex w-full max-w-7xl flex-col-reverse gap-10 px-5 py-20 sm:flex-row">
        <div className="flex w-full flex-col gap-3">
          ...
          <div className="flex items-center gap-4 pt-6">
            <button className="flex items-center justify-center rounded-full bg-gradient-to-r from-[#FFAF4A] to-[#B86BDF] px-10 py-2 text-lg text-white hover:from-[#B86BDF] hover:to-[#FFAF4A] sm:text-xl">
        ...
        <div className="relative h-[300px] max-h-[300px] w-[300px] min-w-[300px] overflow-hidden rounded-full lg:h-[400px] lg:max-h-[400px] lg:w-[400px] lg:min-w-[400px]">
          ...
          <div className="absolute bottom-0 h-[150px] w-[120%] -rotate-6 bg-gradient-to-r from-[#FFAF4A] to-[#B86BDF]"></div>
        </div>
      </section>
    </div>
  );
